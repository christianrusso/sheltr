...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lineChartWithNumbersAndGridLabels = ['12 hs,', '15 hs', '18 hs', '21 hs', '12 hs', '11 hs', '6 hs', '9 hs'];
    ...
    this.lineChartGradientsNumbersLabels = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo',

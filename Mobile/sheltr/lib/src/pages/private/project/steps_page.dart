    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text('Pais', style: TextStyle(fontSize: 15.0, color: Colors.black38)),
          SizedBox(
            height: 5.0,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        RadioButtonCustom(itmesRadios: _radios),
        Padding(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: RaiseButtonCustom(onClick: () async {
            _images = await Utils.loadAssets();
            setState(() {});
          }),
        ),
        SizedBox(
